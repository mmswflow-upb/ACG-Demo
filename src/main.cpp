...
#include "../includes/Character.h" // Contains Character class
#include "../includes/Scene.h" // Contains Scene class
...
int main(void) {
    ...
    texturesProgramID = LoadShaders("shaders/TexturedObjectVertexShader.vertexshader", "shaders/TexturedObjectFragmentShader.fragmentshader");
    GLuint healthbarProgramID = LoadShaders("shaders/HealthbarVertexShader.vertexshader", "shaders/HealthbarFragmentShader.fragmentshader");
    GLuint projectilesProgramID = LoadShaders("shaders/ProjectilesVertexShader.vertexshader", "shaders/ProjectilesFragmentShader.fragmentshader");
    ...
    mainCharacter = new Character(CharacterType::Main, glm::vec3(0.0f, -0.5f, 0.0f), glm::vec3(1.2f, 1.2f, 1.0f), 0.0f, false);

    // Create enemies for each scene
    Character* earthBoss = new Character(CharacterType::EarthBoss, glm::vec3(-0.5f, 0.0f, 0.0f), glm::vec3(1.2f, 1.2f, 1.0f), 90.0f,  false);
    Character* iceBoss = new Character(CharacterType::IceBoss, glm::vec3(0.5f, 0.0f, 0.0f), glm::vec3(1.2f, 1.2f, 1.0f), 270.0f,  false);
    Character* lavaBoss = new Character(CharacterType::LavaBoss, glm::vec3(0.0f, 0.5f, 0.0f), glm::vec3(1.2f, 1.2f, 1.0f), 0.0f, false);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        //Render scene, from the scene render characters of enemies and projectiles, detect collisions, etc
